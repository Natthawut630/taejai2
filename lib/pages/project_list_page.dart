...
import 'package:taejai2/pages/project_details_page.dart';
...
class _ProjectListPageState extends State<ProjectListPage> {
  List<Project> projects = [
    Project(
      ...
      timeProject: 'ระยะเวลาโครงการ 06 ก.พ. 2566 ถึง 06 มี.ค. 2566',
      areaProject: 'ระบุพื้นที่: ตำบลพลูตาหลวง อำเภอสัตหีบ จังหวัดชลบุรี',
    ),
    Project(
